...
# ฟังก์ชันสร้าง neighbors โดยการเลื่อนค่า x ไปซ้ายหรือขวาอย่างสุ่ม
...
def hill_climbing(f, x0):
    ...
    while True:  # วน Loop จนกว่าเงื่อนไขข้างในจะ True
...
# อันนี้ไม่อยู่ใน Slide ลงไปคอมเม้นข้างล่างเลยก็ได้ #
...
# โค้ดด้านบนเป็นการใช้งาน Hill Climbing เพื่อค้นหาค่า x ที่ทำให้ฟังก์ชัน f(x) = x ** 2 มีค่าน้อยที่สุด โดยเริ่มต้นที่ x0 = 10 และสร้าง neighbors
