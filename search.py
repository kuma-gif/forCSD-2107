...
def bestFirstSearch(problem, heuristic=nullHeuristic):
  ...
  #สร้าง priorityqueu ขึ้นมาผ่าน module util
  fringe = util.PriorityQueue()
  #สร้างตัวแปร visited ที่บอกว่าผ่านไปกี่คน
  visited = []
  #สร้าง empty list ที่สร้างไว้เก็บค่า action 
  actionList = []
  #พุตค่าเริ่มต้นและ goal พร้อมกับใส่ค่า heruristic ไปด้วย
